...
//
// Design contract (locked pixel budget): 5-column poster grid, gap 8,
// content padding 20, compact CreditCards (12px title / h32 reserve),
// always-rendered meta lines so every row shares a baseline.
...
export default function PersonCreditsScreen() {
  ...
  const renderItem = useCallback(
    ({ item, index }: { item: TMDbCombinedCredit; index: number }) => {
